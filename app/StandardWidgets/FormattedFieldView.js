 ...
 * @author jskonst
 */
define('FormattedFieldView', ['forms', 'ui', 'forms/formatted-field'], function (Forms, Ui, FormattedField, ModuleName) {
    function module_constructor() {
        var self = this
                , form = Forms.loadForm(ModuleName);

        var formattedField = new FormattedField("Formatted field");
