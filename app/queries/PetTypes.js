...
function PetTypes() {
    ...
    this.schema = [
        // TODO : place schema definition here, such as:
         ...
         {name: "pettypes_id", entity: "pettypes_id", type: Number, key: true},
         {name: "name", entity: "name", type: String } /*, ref: {property: "referencedPropertyName", entity: "referencedEntityName"}},
