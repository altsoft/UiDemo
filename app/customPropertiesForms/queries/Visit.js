...
function Visit() {
    ...
    this.schema = [
        // TODO : place schema definition here, such as:
         ...
         {name: "visit_id", entity: "visit_id", type: Number, key: true},
         {name: "pet_id", entity: "pet_id", type: Number , ref: {property: "pets_id", entity: "Pets"}},
         {name: "fromdate", entity: "fromdate", type: Date },
         {name: "todate", entity: "todate", type: Date }, 
         {name: "description", entity: "description", type: String },
         {name: "ispaid", entity: "ispaid", type: Boolean }
