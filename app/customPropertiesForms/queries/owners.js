...
function Owners() {
    ...
    this.schema = [
        // TODO : place schema definition here, such as:
         ...
         {name: "owners_id", entity: "owners_id", type: Number, key: true},
         {name: "firstname", entity: "firstname", type: String},
         {name: "lastname", entity: "lastname", type: String},
         {name: "address", entity: "address", type: String }, 
         {name: "city", entity: "city", type: String },
         {name: "telephone", entity: "telephone", type: String },
         {name: "email", entity: "email", type: String }
