...
define('BorderPanePanel', ['forms', 'BorderPositionSelection'],
        function (Forms, BorderPositionSelection, ModuleName) {
            //function (Forms, Ui, Env, BorderPane, Label, ModuleName) {
