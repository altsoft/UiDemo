...
//gridBasic
        {name: 'Simple Grid'
            , parent: modelGrid
            , customForm: "ModelGrid/SimpleGrid"
            , commonForm: "CommonProperties"
            , icon: null
...
//gridTree
        {name: 'Tree Grid'
            , parent: modelGrid
            , customForm: "ModelGrid/TreeGrid"
            , commonForm: "CommonProperties"
            , icon: null
            , hint: "Model grid can be used as a Tree grid."
        },
//gridMultiSort
        {name: 'Multi Sort'
            , parent: modelGrid
            , customForm: "ModelGrid/MultiSort"
            , commonForm: "CommonProperties"
            , icon: null
...
//gridMultiHeader;
        {name: 'Multi Header'
            , parent: modelGrid
            , customForm: "ModelGrid/MultiHeader"
            , commonForm: "CommonProperties"
            , icon: null
...
//gridFrozenRows
        {name: 'Frozen Rows'
            , parent: modelGrid
            , customForm: "ModelGrid/FrozenRows"
            , commonForm: "CommonProperties"
            , icon: null
...
//gridFrozenColumns;
        {name: 'Frozen Columns'
            , parent: modelGrid
            , customForm: "ModelGrid/FrozenColumns"
            , commonForm: "CommonProperties"
            , icon: null
...
//gridRowsSelection
        {name: 'Rows Selection'
            , parent: modelGrid
            , customForm: "ModelGrid/RowsSelection"
            , commonForm: "CommonProperties"
            , icon: null
...
//gridEditingInline 
        {name: 'Inline Editing'
            , parent: modelGrid
            , customForm: "ModelGrid/EditingInline"
            , commonForm: "CommonProperties"
            , icon: null
...
//gridEditingPopup
        {name: 'Popup Editing'
            , parent: modelGrid
            , customForm: "ModelGrid/EditingPopup"
            , commonForm: "CommonProperties"
            , icon: null
...
//gridOrmBinding
        {name: 'ORM Binding'
            , parent: modelGrid
            , customForm: "ModelGrid/OrmBinding"
            , commonForm: "CommonProperties"
            , icon: null
...
//gridES6Binding 
        {name: 'Es6 Binding'
            , parent: modelGrid
            , customForm: "ModelGrid/Es6Binding"
            , commonForm: "CommonProperties"
            , icon: null
            , hint: "If browser supports ECMAScript 6 Proxies, than plain JavaScript array may be bound with ModelGrid."
        },
//gridToExcel 
        {name: 'Export to Excel'
            , parent: modelGrid
            , customForm: "ModelGrid/ToExcel"
            , commonForm: "CommonProperties"
            , icon: null
